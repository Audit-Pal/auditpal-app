            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {analyticsItems.map((item, index) => (
                    <motion.div
                        ...
                        className="group relative p-3 bg-card border border-border rounded-md hover:bg-accent hover:shadow-sm transition-all duration-300 flex flex-col justify-between h-full"
                    >
                        <div>
                            <div className="flex items-center justify-between mb-3">
                                <div className={`p-1.5 rounded-sm bg-muted border border-border shadow-sm ${item.color}`}>
                        ...
                        <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-kast-teal/30 opacity-0 group-hover:opacity-100 transition-opacity" />
                    </motion.div>
                ))}
            </div>
        </DataModule>
