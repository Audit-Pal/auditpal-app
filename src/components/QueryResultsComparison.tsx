...
export default function QueryResultsComparison({
        ...
        return (
            <div className={`${className}`}>
                <div className="bg-card border border-border rounded-xl p-8 text-center shadow-sm">
                    ...
                    <h3 className="text-xl font-bold text-foreground mb-2 uppercase">No Sample Query Results</h3>
    ...
    return (
        <div className={`${className}`}>
            ...
            <div className="border border-border bg-card rounded-none p-6 shadow-sm">
                {/* Header */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={expandAll}
                            className="text-xs px-3 py-1.5 bg-muted border border-border hover:bg-accent text-foreground rounded-md transition-colors shadow-sm font-bold uppercase tracking-wider"
                        >
                            Expand All
                        </button>
                        <button
                                ...
                                >
                                    <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-4 mr-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className={`text-base font-bold font-mono ${isExpanded ? 'text-foreground' : 'text-muted-foreground'} transition-colors`}>
                                                Query #{index + 1}
                                            </span>
                                        </div>
                                        ...
                                        <div className="flex items-center bg-white/5 rounded-lg border border-white/5 py-1.5 translate-x-4">
                                            {/* Words */}
                                            <div className="flex flex-col items-end px-5 border-r border-border">
                                                <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-[0.2em] mb-1.5 leading-none">Words</span>
                                                <div className="flex items-center gap-2">
                                                    <span className="text-sm font-bold text-foreground font-mono tracking-tighter">
                                            ...
                                            {/* Reduction */}
                                            <div className="hidden sm:flex flex-col items-end px-5 border-r border-border">
                                ...
                                {isExpanded && (
                                    ...
                                    >
                                        ...
                                        <div className="px-6 py-4 bg-muted">
                                            ...
                                            <div className="text-sm text-foreground font-mono bg-background border border-border rounded-lg p-4 shadow-sm">
                                                {result.query}
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border-t border-border">
                                            ...
                                            <div className="p-6 border-r border-border bg-muted/50">
                                                ...
                                                {/* Response Content */}
                                                <div
                                                    className="scrollable-content w-full max-h-48 overflow-y-auto bg-background border border-border rounded-lg p-3 shadow-sm text-xs font-mono text-muted-foreground whitespace-pre-wrap leading-relaxed"
