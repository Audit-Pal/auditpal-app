    ...
    <header className="fixed top-0 z-50 w-full border-b border-border bg-background">
      ...
      <div className="container flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden md:flex items-center space-x-10">
          <Link
            href="/network"
            className="text-sm font-medium text-muted-foreground hover:text-kast-teal transition-colors py-2 flex items-center gap-1.5"
          >
            Network
          </Link>
          <Link
        ...
        <div className="hidden md:flex items-center gap-2">
          <ThemeToggle />
          <Button asChild className="bg-primary text-primary-foreground hover:bg-kast-teal hover:text-background rounded-full px-6 font-bold text-sm transition-all shadow-[0_0_20px_rgba(30,186,152,0.1)] border border-kast-teal/50">
        ...
        {/* Mobile Menu Overlay */}
        {isMobileMenuOpen && (
          <div className="fixed inset-0 top-16 z-40 bg-background border-t border-border flex flex-col p-6 md:hidden animate-in slide-in-from-top-4 duration-300">
            <nav className="flex flex-col space-y-6">
              <Link
                href="/network"
                className="text-sm font-medium text-muted-foreground hover:text-kast-teal transition-colors py-4 border-b border-border"
              ...
              <div className="pt-4 flex flex-col">
                <Button asChild size="lg" className="w-full bg-primary text-primary-foreground hover:bg-kast-teal hover:text-background rounded-none font-bold border border-kast-teal/50 shadow-lg transition-all duration-300">
