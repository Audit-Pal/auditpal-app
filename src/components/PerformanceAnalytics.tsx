    ...
    if (active && payload && payload.length) {
        return (
            <div className="bg-card border border-border p-3 rounded-lg shadow-xl">
                <p className="text-muted-foreground text-[10px] uppercase tracking-wider mb-2 font-mono">{label}</p>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="border border-border bg-card rounded-2xl p-6 shadow-2xl">
                ...
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <h2 className="text-base font-bold text-foreground uppercase tracking-widest font-mono">
                        AUDIT_PERFORMANCE
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
                    ...
                    <div className="border border-border bg-muted/30 rounded-2xl flex flex-col items-center justify-center p-6 h-full min-h-[220px]">
                        <div className="relative w-32 h-32 flex items-center justify-center mb-4">
                            <svg className="w-full h-full transform -rotate-90" viewBox="0 0 128 128" preserveAspectRatio="xMidYMid meet">
                                <circle cx="64" cy="64" r="60" stroke="currentColor" className="text-muted" strokeWidth="8" fill="transparent" />
                                <motion.circle
                                    cx="64" cy="64" r="60"
                                    stroke="#1EBA98"
                                    strokeWidth="8"
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-[54%] -translate-y-[60%] flex items-center justify-center">
                                <span className="text-3xl font-bold text-foreground">${costSavingsPer1000.toFixed(2)}</span>
                            </div>
                            <div className="absolute inset-x-0 bottom-9 flex justify-center">
                                <span className="text-[10px] text-muted-foreground uppercase tracking-widest">PER 1K RUNS</span>
                            </div>
                        </div>
                        <h3 className="text-sm font-bold text-foreground uppercase tracking-widest mb-1">COST_EFFICIENCY</h3>
                    </div>

                    {/* Token Comparison Section */}
                    <div className="border border-border bg-muted/30 rounded-2xl flex flex-col h-full overflow-hidden">
                        <div className="pb-2 border-b border-border bg-muted/30 p-4">
                            <CardTitle className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest font-mono flex items-center gap-2 mb-2">
                            ...
                            <div className="flex items-baseline gap-2">
                                <span className="text-2xl font-black text-foreground font-mono tracking-tight">
                                    ...
                                    <span className="text-[10px] font-bold text-muted-foreground ml-1">tokens</span>
                                </span>
                            ...
                            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest font-mono mt-0.5">SAVED PER QUERY</p>
                        </div>
                        <div className="flex-1 flex flex-col p-4">
                            <div className="h-[80px] w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={[chartData[0]]} layout="vertical" margin={{ top: 0, right: 0, left: 0, bottom: 0 }} barSize={18} barGap={8}>
                                        <CartesianGrid strokeDasharray="3 3" horizontal={false} vertical={true} stroke="currentColor" className="text-border" />
                                        <XAxis type="number" stroke="currentColor" className="text-muted-foreground" fontSize={8} tickLine={false} axisLine={false} fontFamily="monospace" />
                            ...
                            <div className="flex flex-col gap-1.5 mt-2">
                                <div className="flex items-center justify-between text-[8px] font-bold font-mono text-muted-foreground uppercase">
                        ...
                        <div className="pb-2 border-b border-border bg-muted/30 p-4">
                            ...
                            <div className="flex items-baseline gap-2">
                                <span className="text-2xl font-black text-foreground font-mono tracking-tight">
                                    ...
                                    <span className="text-[10px] font-bold text-muted-foreground ml-1">ms</span>
                                </span>
                            ...
                            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest font-mono mt-0.5">FASTER RESPONSE</p>
                        </div>
                        <div className="flex-1 flex flex-col p-4">
                            <div className="h-[80px] w-full">
                                <ResponsiveContainer width="100%" height="100%">
