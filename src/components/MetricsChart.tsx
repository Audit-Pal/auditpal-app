...
export default function MetricsChart({
    ...
    const CustomTooltip = ({ active, payload, label }: any) => {
        if (active && payload && payload.length) {
            return (
                <div className="bg-card border border-border p-2 rounded-sm shadow-xl backdrop-blur-md">
                    <div className="text-[10px] text-muted-foreground font-mono tracking-widest mb-1">{label}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
                <div className="h-[200px] w-full relative">
                    ...
                    <div className="absolute bottom-2 right-2 font-mono text-[9px] text-muted-foreground text-right">
            ...
            >
                <div className="h-[200px] w-full relative">
                    ...
                    {/* Technical Readout Overlay */}
                    <div className="absolute bottom-2 right-2 font-mono text-[9px] text-zinc-600 text-right">
