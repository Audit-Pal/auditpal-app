...
export default function PromptComparison({
    ...
    return (
        <>
            ...
            <DataModule
                className={`transition-all duration-500 ease-in-out ${isExpanded ? "fixed inset-4 z-[100] h-[calc(100vh-2rem)] bg-card shadow-2xl rounded-2xl border border-border" : "h-[450px] bg-card border border-border rounded-2xl"}`}
